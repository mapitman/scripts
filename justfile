...
scripts := "development/git-clone-all development/git-status-all general/mktlapse general/nmapscan general/selfcert general/strip-ext qemu/vmctl"
man_sources := "man/git-clone-all.1.md man/git-status-all.1.md man/mktlapse.1.md man/nmapscan.1.md man/selfcert.1.md man/strip-ext.1.md man/vmctl.1.md"
